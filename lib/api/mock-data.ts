...
export const MOCK_PLAN: ServicePlan = {
  ...
  safetyVisitsTotal: 12,
  safetyVisitsCompleted: 8,
  autoRenew: true,
...
export const MOCK_APPOINTMENTS: Appointment[] = [
  ...
  },
  {
    ...
    bookedBy: "Client",
    notes: "Environmental safety check and grab-bar review.",
  },
  {
    id: "appt_090",
    serviceType: "Safety Oversight",
    ...
    bookedBy: "Client",
    reportId: "rep_201",
    reportTitle: "Home Safety Oversight Summary",
    notes:
      "Pathway safety and walkway clutter inspection completed successfully.",
  },
  {
    id: "appt_089",
    serviceType: "Safety Oversight",
...
export const MOCK_REPORTS: Report[] = [
  ...
  {
    id: "rep_201",
    title: "Home Safety Oversight Summary",
    visitDate: "August 12, 2026",
    score: 98,
    status: "available",
    pdfUrl: "#",
    summary:
      "Completed environmental safety check of high-traffic zones. No physical hazards identified.",
